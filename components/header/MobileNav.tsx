...
export function MobileNav({
  ...
  return (
    <div
      id="mobile-nav"
      className="animate-mega-drop border-t border-line bg-elev/95 px-5 py-6 backdrop-blur-xl shadow-2xl lg:hidden"
    >
      ...
      <div className="mt-5 grid gap-1 pt-4 border-t border-line">
        {user ? (
          <>
            {user.role === "BUSINESS" ? (
        ...
        <Link
          ...
          onClick={onClose}
          className="mt-3 inline-flex h-11 items-center justify-center gap-2 rounded-full bg-blue font-medium text-white shadow-lg shadow-blue/20 transition hover:bg-blue-hover"
        >
